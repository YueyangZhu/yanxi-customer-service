...
function AgentPage() {
  ...
  return <main className="workspace">
    ...
    <section className="ticket-detail">{selected ? <>
      ...
      <div className="ticket-context"><div><small>转人工原因</small><strong>{selected.handoff_reason}</strong></div><div><small>AI 置信度</small><strong>{Math.round((selected.confidence || 0) * 100)}%</strong></div><div><small>创建时间</small><strong>{formatTime(selected.created_at)}</strong></div></div>
